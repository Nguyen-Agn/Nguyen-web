...
const DecayCard = ({ width = 720, height = 420, image = 'https://picsum.photos/300/400?grayscale', children }) => {
  ...
  return (
    <div ref={svgRef} className="relative rounded-2xl" style={{ width: `${width}px`, height: `${height}px` }}>
      <svg
        viewBox="0 0 720 420"
        preserveAspectRatio="xMidYMid slice"
        className="absolute w-full h-full block [will-change:transform] rounded-2xl"
      >
        <filter id="imgFilter">
          <feTurbulence
            type="turbulence"
      ...
      <div className="absolute bottom-[1.2em] left-[1em] tracking-[-0.5px] text-[2.5rem] leading-[1.5em] bg-white/30 backdrop-blur-sm px-4 py-2 rounded-md text-black font-semibold">
        {children}
      </div>
    </div>
  );
